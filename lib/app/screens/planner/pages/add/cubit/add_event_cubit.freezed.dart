...
class _$_AddEventState implements _AddEventState {
  _$_AddEventState({this.status = Status.initial, this.errorMessage});
  ...
  @override
  String toString() {
    return 'AddEventState(status: $status, errorMessage: $errorMessage)';
  }
...
abstract class _AddEventState implements AddEventState {
  factory _AddEventState({final Status status, final String? errorMessage}) =
      _$_AddEventState;
